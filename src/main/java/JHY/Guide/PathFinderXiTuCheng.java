    ...
    public void FindShortestPath(int Source) {
        ...
        while (p < Graph.getVertices()) {
            ...
            for (int i = 0 ; i < Adjacent.length;i ++) {
                ...
                if (weigtedEgde != null) {
                    double NewDistance = weigtedEgde.getWeight() * (new GuideByTime().getTimeXiTuCheng(bestNode, weigtedEgde.getAdjacentVertexNumber())) + DistanceTo[bestNode];
